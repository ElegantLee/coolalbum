...
<meta http-equiv="Cache-Control"
	content="no-cache,no-transform,no-siteapp">
...
<body>
	...
	<div class="layui-upload">
		...
		<blockquote class="layui-elem-quote layui-quote-nm"
			...
			<input type="hidden" id="btn" class="layui-btn layui-btn-danger"
				value="确认上传">
		</blockquote>
	</div>
	...
	<form action="" method="post" id="myphoto">
		...
		<div style="float: left;margin-left:40px;"
			class="main-cont main-waterfall">
			<input type="checkbox" name="delphotocheckbox" :value="photo.id"
				title="发呆" lay-skin="primary">
			<ul style="width:332px;height:282px;"
				class="main-cont__list clearfix">

				<li style="width:331px;height:281px;" style="margin-left:20px"
					class="item item-cur"><span class="pic"> <img
						style="width:330px;height:280px;" :src="photo.address">
				</span></li>
